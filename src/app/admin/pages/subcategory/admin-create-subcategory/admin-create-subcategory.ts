...
@Component({
  selector: 'app-admin-create-subcategory',
  standalone: false,
  templateUrl: './admin-create-subcategory.html',
  styleUrl: './admin-create-subcategory.css',
})
export class AdminCreateSubcategory {
