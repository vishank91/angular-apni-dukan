...
@Component({
  selector: 'app-admin-create-maincategory',
  standalone: false,
  templateUrl: './admin-create-maincategory.html',
  styleUrl: './admin-create-maincategory.css',
})
export class AdminCreateMaincategory {
